namespace ControlDeProyectos
{
    partial class VistaInicio
    {
        ...
        private void InitializeComponent()
        {
            ...
            div_botones3 = new Panel();
            panelSubMenuEstadisticas = new Panel();
            button2 = new Button();
            button3 = new Button();
            button4 = new Button();
            ...
            menu_lateral.BackColor = Color.FromArgb(222, 205, 179);
            menu_lateral.Controls.Add(div_botones3);
            ...
            menu_lateral.Size = new Size(250, 742);
            menu_lateral.TabIndex = 0;
            // 
            // div_botones3
            // 
            div_botones3.BackColor = Color.FromArgb(0, 0, 32);
            ...
            // 
            panelSubMenuEstadisticas.BackColor = Color.FromArgb(242, 225, 199);
            panelSubMenuEstadisticas.Controls.Add(button2);
            ...
            button2.FlatAppearance.MouseDownBackColor = Color.FromArgb(212, 195, 169);
            button2.FlatAppearance.MouseOverBackColor = Color.FromArgb(232, 215, 189);
            ...
            button3.FlatAppearance.MouseDownBackColor = Color.FromArgb(212, 195, 169);
            button3.FlatAppearance.MouseOverBackColor = Color.FromArgb(232, 215, 189);
            ...
            button4.FlatAppearance.MouseDownBackColor = Color.FromArgb(212, 195, 169);
            button4.FlatAppearance.MouseOverBackColor = Color.FromArgb(232, 215, 189);
            ...
            button4.TabIndex = 5;
            button4.Text = "Registrar ingreso";
            button4.TextAlign = ContentAlignment.MiddleLeft;
            button4.UseVisualStyleBackColor = true;
            // 
            // boton_estadisticas
            // 
            boton_estadisticas.Cursor = Cursors.Hand;
            boton_estadisticas.Dock = DockStyle.Top;
            boton_estadisticas.FlatAppearance.BorderSize = 0;
            boton_estadisticas.FlatAppearance.MouseDownBackColor = Color.FromArgb(212, 195, 169);
            ...
            boton_estadisticas.TabIndex = 8;
            boton_estadisticas.Text = "Estadisticas";
            boton_estadisticas.TextAlign = ContentAlignment.MiddleLeft;
            boton_estadisticas.UseVisualStyleBackColor = true;
            boton_estadisticas.Click += boton_estadisticas_Click;
            // 
            // div_botones2
            // 
            div_botones2.BackColor = Color.FromArgb(0, 0, 32);
            ...
            // boton_tarjetas
            // 
            boton_tarjetas.Cursor = Cursors.Hand;
            boton_tarjetas.Dock = DockStyle.Top;
            boton_tarjetas.FlatAppearance.BorderSize = 0;
            boton_tarjetas.FlatAppearance.MouseDownBackColor = Color.FromArgb(212, 195, 169);
            boton_tarjetas.FlatAppearance.MouseOverBackColor = Color.FromArgb(232, 215, 189);
            boton_tarjetas.FlatStyle = FlatStyle.Flat;
            boton_tarjetas.ForeColor = Color.Black;
            boton_tarjetas.Location = new Point(0, 40);
            boton_tarjetas.Name = "boton_tarjetas";
            boton_tarjetas.Padding = new Padding(35, 0, 0, 0);
            boton_tarjetas.Size = new Size(250, 40);
            boton_tarjetas.TabIndex = 6;
            boton_tarjetas.Text = "Tarjetas";
            boton_tarjetas.TextAlign = ContentAlignment.MiddleLeft;
            boton_tarjetas.UseVisualStyleBackColor = true;
            // 
            // boton_lista
            // 
            boton_lista.Cursor = Cursors.Hand;
            boton_lista.Dock = DockStyle.Top;
            boton_lista.FlatAppearance.BorderSize = 0;
            boton_lista.FlatAppearance.MouseDownBackColor = Color.FromArgb(212, 195, 169);
            boton_lista.FlatAppearance.MouseOverBackColor = Color.FromArgb(232, 215, 189);
            boton_lista.FlatStyle = FlatStyle.Flat;
            boton_lista.ForeColor = Color.Black;
            boton_lista.Location = new Point(0, 0);
            boton_lista.Name = "boton_lista";
            boton_lista.Padding = new Padding(35, 0, 0, 0);
            boton_lista.Size = new Size(250, 40);
            boton_lista.TabIndex = 5;
            boton_lista.Text = "Lista";
            boton_lista.TextAlign = ContentAlignment.MiddleLeft;
            boton_lista.UseVisualStyleBackColor = true;
            // 
            // boton_busqueda
            // 
            boton_busqueda.Cursor = Cursors.Hand;
            boton_busqueda.Dock = DockStyle.Top;
            boton_busqueda.FlatAppearance.BorderSize = 0;
            boton_busqueda.FlatAppearance.MouseDownBackColor = Color.FromArgb(212, 195, 169);
            boton_busqueda.FlatAppearance.MouseOverBackColor = Color.FromArgb(232, 215, 189);
            boton_busqueda.FlatStyle = FlatStyle.Flat;
            boton_busqueda.ForeColor = Color.Black;
            boton_busqueda.Location = new Point(0, 280);
            boton_busqueda.Name = "boton_busqueda";
            boton_busqueda.Padding = new Padding(10, 0, 0, 0);
            boton_busqueda.Size = new Size(250, 45);
            boton_busqueda.TabIndex = 5;
            boton_busqueda.Text = "Busquedas";
            boton_busqueda.TextAlign = ContentAlignment.MiddleLeft;
            boton_busqueda.UseVisualStyleBackColor = true;
            boton_busqueda.Click += boton_busqueda_Click;
            // 
            // div_botones1
            // 
            div_botones1.BackColor = Color.FromArgb(0, 0, 32);
            div_botones1.Dock = DockStyle.Top;
            div_botones1.Location = new Point(0, 279);
            div_botones1.Name = "div_botones1";
            div_botones1.Size = new Size(250, 1);
            div_botones1.TabIndex = 4;
            // 
            // panelSubMenuAdministrar
            // 
            panelSubMenuAdministrar.BackColor = Color.FromArgb(242, 225, 199);
            ...
            boton_error.FlatAppearance.MouseDownBackColor = Color.FromArgb(212, 195, 169);
            boton_error.FlatAppearance.MouseOverBackColor = Color.FromArgb(232, 215, 189);
            boton_error.FlatStyle = FlatStyle.Flat;
            boton_error.ForeColor = Color.Black;
            ...
            boton_editar.FlatAppearance.MouseDownBackColor = Color.FromArgb(212, 195, 169);
            boton_editar.FlatAppearance.MouseOverBackColor = Color.FromArgb(232, 215, 189);
            boton_editar.FlatStyle = FlatStyle.Flat;
            boton_editar.ForeColor = Color.Black;
            ...
            boton_agregar.FlatAppearance.MouseDownBackColor = Color.FromArgb(212, 195, 169);
            boton_agregar.FlatAppearance.MouseOverBackColor = Color.FromArgb(232, 215, 189);
            boton_agregar.FlatStyle = FlatStyle.Flat;
            boton_agregar.ForeColor = Color.Black;
            ...
            boton_administrar.FlatAppearance.MouseDownBackColor = Color.FromArgb(212, 195, 169);
            boton_administrar.FlatAppearance.MouseOverBackColor = Color.FromArgb(232, 215, 189);
            boton_administrar.FlatStyle = FlatStyle.Flat;
            boton_administrar.ForeColor = Color.Black;
            ...
            // panelSubMenuLogo
            // 
            panelSubMenuLogo.BackColor = Color.FromArgb(222, 205, 179);
            panelSubMenuLogo.Controls.Add(logo_principal);
            panelSubMenuLogo.Controls.Add(titulo_principal);
            panelSubMenuLogo.Controls.Add(div_botones0);
            ...
            logo_principal.TabIndex = 5;
            logo_principal.TabStop = false;
            // 
            // titulo_principal
            // 
            ...
            // div_botones0
            // 
            div_botones0.BackColor = Color.FromArgb(0, 0, 32);
            div_botones0.Dock = DockStyle.Bottom;
            div_botones0.Location = new Point(0, 110);
            div_botones0.Name = "div_botones0";
            div_botones0.Size = new Size(250, 1);
            div_botones0.TabIndex = 3;
            // 
            // panelHijo
            // 
